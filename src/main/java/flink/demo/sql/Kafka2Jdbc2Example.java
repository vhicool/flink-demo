...
/**
 * <p>Description: 从kafka到mysq到mysql增量同步</p>
 *
 * @author lidawei
 * @date 2020/10/30
 * @since
 **/
public class Kafka2Jdbc2Example {
...
//		String kafka2jdbc = "insert into user_behavior_sink select user_id,item_id,category_id from user_behavior";
		String jdbc2kafka = "insert into user_behavior_sink select user_id,item_id,category_id from user_behavior";
